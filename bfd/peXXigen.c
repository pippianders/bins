 ...
 * COFF_WITH_riscv64, or COFF_WITH_peaa64 depending on whether we're compiling
 * for straight PE or PE+.  */
#define COFF_WITH_XX
...
#if defined(COFF_WITH_pep) || defined(COFF_WITH_riscv64) || defined(COFF_WITH_pex64)
# undef AOUTSZ
