...
#define _bfd_XX_bfd_copy_private_bfd_data_common	_bfd_peaa64_bfd_copy_private_bfd_data_common
#define _bfd_XX_bfd_copy_private_section_data		_bfd_peaa64_bfd_copy_private_section_data
#define _bfd_XX_get_symbol_info				_bfd_peaa64_get_symbol_info
#define _bfd_XX_only_swap_filehdr_out			_bfd_peaa64_only_swap_filehdr_out
#define _bfd_XX_print_private_bfd_data_common		_bfd_peaa64_print_private_bfd_data_common
#define _bfd_XXi_final_link_postscript			_bfd_peaa64i_final_link_postscript
#define _bfd_XXi_only_swap_filehdr_out			_bfd_peaa64i_only_swap_filehdr_out
#define _bfd_XXi_swap_aouthdr_in			_bfd_peaa64i_swap_aouthdr_in
#define _bfd_XXi_swap_aouthdr_out			_bfd_peaa64i_swap_aouthdr_out
#define _bfd_XXi_swap_aux_in				_bfd_peaa64i_swap_aux_in
#define _bfd_XXi_swap_aux_out				_bfd_peaa64i_swap_aux_out
#define _bfd_XXi_swap_lineno_in				_bfd_peaa64i_swap_lineno_in
#define _bfd_XXi_swap_lineno_out			_bfd_peaa64i_swap_lineno_out
#define _bfd_XXi_swap_scnhdr_out			_bfd_peaa64i_swap_scnhdr_out
#define _bfd_XXi_swap_sym_in				_bfd_peaa64i_swap_sym_in
#define _bfd_XXi_swap_sym_out				_bfd_peaa64i_swap_sym_out
#define _bfd_XXi_swap_debugdir_in			_bfd_peaa64i_swap_debugdir_in
#define _bfd_XXi_swap_debugdir_out			_bfd_peaa64i_swap_debugdir_out
#define _bfd_XXi_write_codeview_record			_bfd_peaa64i_write_codeview_record
#define _bfd_XXi_slurp_codeview_record			_bfd_peaa64i_slurp_codeview_record
...
bool _bfd_peaa64_print_ce_compressed_pdata (bfd *, void *);
